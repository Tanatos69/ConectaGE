...
export function WhatsAppCTA({
  ...
  const msg = listingUrl
    ? `Hola, me interesa tu anuncio: ${listingTitle} ${listingUrl}`
  ...
  return (
    <a
      ...
      className={cn(
        ...
        size === "lg"
          ? "h-14 px-6 text-base shadow-lg shadow-[#25D366]/20"
          : "h-12 px-5 text-sm",
        className,
      )}
    >
      <svg
        ...
        fill="currentColor"
        aria-hidden="true"
        className={cn(size === "lg" ? "size-6" : "size-5", "shrink-0")}
      >
