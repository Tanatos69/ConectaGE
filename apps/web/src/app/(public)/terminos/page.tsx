  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
        Al acceder o utilizar la plataforma {BRAND.name} (&ldquo;el Servicio&rdquo;), aceptas
      ...
      <Section title="1. Descripción del servicio">
        <p>
          {BRAND.name} es una plataforma de anuncios clasificados que permite a usuarios particulares
      ...
      <Section title="2. Registro y cuenta de usuario">
        ...
        <p>
          Debes proporcionar información veraz y actualizada. {BRAND.name} se reserva el derecho de
      ...
      <Section title="5. Responsabilidad del usuario">
        <p>
          {BRAND.name} no es parte en las transacciones entre usuarios y no garantiza la calidad,
      ...
      <Section title="6. Propiedad intelectual">
        <p>
          Al publicar contenido (textos, imágenes, etc.) en {BRAND.name}, nos concedes una licencia
      ...
      <Section title="7. Tratamiento de datos y analítica">
        <p>
          Con el fin de operar, proteger y mejorar el Servicio, {BRAND.name} recopila datos de uso de
        ...
        <p>
          ...
          <strong className="text-foreground">
            {BRAND.name} no cede, comparte ni vende datos personales ni datos de uso a terceros.
          </strong>{" "}
      ...
      <Section title="8. Limitación de responsabilidad">
        <p>
          {BRAND.name} no será responsable por daños directos, indirectos, incidentales o
      ...
      <Section title="11. Contacto">
        <p>
          ...
          <a href={`mailto:${BRAND.emails.legal}`} className="text-primary hover:underline">
            {BRAND.emails.legal}
          </a>
          .
        </p>
