...
export const demoSellers: SellerProfile[] = [
  ...
  },
  {
    ...
    city: "Malabo",
    bio: "Vendo gadgets y accesorios de electrónica a buen precio. Atención rápida por WhatsApp.",
  },
  {
    username: "inmobiliaria_ge",
    name: "Ana Nsue Obiang",
    ...
    city: "Malabo",
    bio: "Agente inmobiliaria con amplia cartera de pisos y locales en Malabo. Sin intermediarios.",
    professional: true,
    storeSlug: "inmuebles-esono",
  },
  {
    ...
    activeListings: 12,
    verified: true,
    whatsapp: "+240333111000",
    city: "Ebebiyín",
    bio: "Parcelas y terrenos en la región del Centro Sur. Documentación en regla garantizada.",
    professional: true,
  },
  {
    username: "empresa_logistica_ge",
    name: "Pedro Ondo Nzang",
    memberSince: "Septiembre 2024",
    rating: 4.1,
    reviewsCount: 5,
    activeListings: 7,
    verified: false,
    whatsapp: "+240333777888",
    city: "Bata",
    bio: "Servicios de transporte y logística en el continente. Flota propia, tarifas competitivas.",
    professional: true,
  },
  {
    username: "boutique_malabo",
    name: "Lucía Maye",
    ...
    activeListings: 18,
    verified: true,
    whatsapp: "+240222999000",
    city: "Malabo",
    bio: "Moda femenina y accesorios con estilo. Prendas originales, tallajes africanos e importados.",
    professional: true,
    storeSlug: "boutique-malabo",
  },
  {
    username: "tech_store_bata",
    name: "Robert Esono",
    ...
    activeListings: 24,
    verified: true,
    whatsapp: "+240333222333",
    city: "Bata",
    bio: "Tienda de informática y electrónica en Bata. Stock siempre renovado, servicio técnico incluido.",
    professional: true,
    storeSlug: "tech-bata",
  },
  {
    username: "motos_ge_24",
    name: "Santiago Nguema",
    ...
    whatsapp: "+240222456789",
    city: "Malabo",
    bio: "Compra y venta de motocicletas de segunda mano. Revisión mecánica previa a cada venta.",
  },
];
